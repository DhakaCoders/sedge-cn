    ...
    <div class="xs-mbl-footer">
      <div class="xs-mbl-link">
        <ul class="reset-list">
          ...
          <li><a href="#">Bekijk de voorwaarden</a></li>
        </ul>
      </div>
...
<section class="ftr-top-sec">
  <div class="ftrTopSlider clearfix">
    <div class="ftr-slider-grd-item">
      <img src="assets/images/ftr-top-img-01.jpg">
    </div>
    <div class="ftr-slider-grd-item">
      <img src="assets/images/ftr-top-img-02.jpg">
    </div>
    <div class="ftr-slider-grd-item">
      <img src="assets/images/ftr-top-img-03.jpg">
    </div>
    <div class="ftr-slider-grd-item">
      <img src="assets/images/ftr-top-img-01.jpg">
    </div>
          ...
          <div class="ftr-top-inr clearfix">
            ...
            <div class="ftr-menu ftr-col-3 hide-sm">
              ...
              <div class="ftr-location">
                <a target="_blank" href="#">Adres Line 1,<br>Aalst, Belgium</a>
              </div>
              <div class="ftr-email">
                <a href="mailto:">info@sedge.be</a>
              </div>
              <div class="ftr-phone">
                <a href="tel:053222333">053 222 333</a>
              </div>
              <div class="ftr-social-media">
                <ul class="reset-list">
                  <li><a href="#"><i class="fab fa-facebook-f"></i><span>Facebook</span></a></li>
        ...
        <div class="col-md-12">
          <div class="ftr-btm-inr">
            ...
            <div class="ftr-copywrite">
              <p>&copy;2019 - 2020 SEDGE. All Rights Reserved.</p>
            </div>
